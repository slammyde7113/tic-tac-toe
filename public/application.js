...
/***/ (function(module, exports, __webpack_require__) {
	...
	var onGamesPlayed = function onGamesPlayed(event) {
	  event.preventDefault();
	  console.log('checking...');

	  api.gamesPlayed().then(ui.gamesPlayedSuccess).catch(ui.gamesPlayedFailure);
	};
	var onCurrentGameOver = function onCurrentGameOver(event) {
	  event.preventDefault();
	  console.log('checking1111...');

	  api.currentGameOver().then(ui.gamePlayedSuccess).catch(ui.gamesPlayedFailure);
	};
	...
	var onJoinGame = function onJoinGame(event) {
	  ...
	  .then(ui.joinGameSuccess).catch(ui.joinGameFailure);
	  // using the Promise tot ensure order execution
	  // .then() afterwards takes the results of the previous .then()
	};
	var onBox1 = function onBox1(event) {
	  // prefer event.target over this
	  event.preventDefault();
	  // initiates an HTTP request that was defined in the api module as singUp
	...
	var onBox2 = function onBox2(event) {
	  // prefer event.target over this
	  event.preventDefault();
	...
	var onBox3 = function onBox3(event) {
	  // prefer event.target over this
	  event.preventDefault();
	  // initiates an HTTP request that was defined in the api module as singUp
	...
	var onBox4 = function onBox4(event) {
	  // prefer event.target over this
	  event.preventDefault();
	  // initiates an HTTP request that was defined in the api module as singUp
	...
	var onBox5 = function onBox5(event) {
	  // prefer event.target over this
	  event.preventDefault();
	  // initiates an HTTP request that was defined in the api module as singUp
	...
	var onBox6 = function onBox6(event) {
	  // prefer event.target over this
	  event.preventDefault();
	  // initiates an HTTP request that was defined in the api module as singUp
	...
	var onBox7 = function onBox7(event) {
	  // prefer event.target over this
	  event.preventDefault();
	  // initiates an HTTP request that was defined in the api module as singUp
	...
	var onBox8 = function onBox8(event) {
	  // prefer event.target over this
	  event.preventDefault();
	  // initiates an HTTP request that was defined in the api module as singUp
	...
	var onBox9 = function onBox9(event) {
	  // prefer event.target over this
	  event.preventDefault();
	  // initiates an HTTP request that was defined in the api module as singUp
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var gamesPlayed = function gamesPlayed(data) {
	  return $.ajax({
	...
	var currentGameOver = function currentGameOver(data) {
	  return $.ajax({
	    url: config.apiOrigins.production + '/games?overfalse',
	    method: 'GET',
	    headers: {
	...
	var joinGame = function joinGame(data) {
	  console.log(data);
	  var gameId = JSON.stringify(data);
	...
	var box1Click = function box1Click() {
	  if (store.counter % 2) {
	    store.player = 'O';
	  } else {
	    store.player = 'X';
	...
	var box2Click = function box2Click() {
	  console.log('pressed');
	  if (store.counter % 2) {
	    store.player = 'O';
	    store.counter;
	...
	var box3Click = function box3Click() {
	  if (store.counter % 2) {
	    store.player = 'O';
	    store.counter;
	  } else {
	...
	var box4Click = function box4Click() {
	  if (store.counter % 2) {
	    store.player = 'O';
	    store.counter;
	  } else {
	...
	var box5Click = function box5Click() {
	  if (store.counter % 2) {
	    store.player = 'O';
	    store.counter;
	  } else {
	...
	var box6Click = function box6Click() {
	  if (store.counter % 2) {
	    store.player = 'O';
	    store.counter;
	  } else {
	...
	var box7Click = function box7Click() {
	  if (store.counter % 2) {
	    store.player = 'O';
	    store.counter;
	  } else {
	...
	var box8Click = function box8Click() {
	  if (store.counter % 2) {
	    store.player = 'O';
	    store.counter;
	  } else {
	...
	var box9Click = function box9Click() {
	  if (store.counter % 2) {
	    store.player = 'O';
	    store.counter;
	  } else {
	...
	module.exports = {
	  ...
	  currentGameOver: currentGameOver,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var api = __webpack_require__(10);
	store.play = false;
	var isXOrO = function isXOrO(array, letter) {
	  var results = [];
	...
	var winTest = function winTest(array) {
	  var pos0 = false;
	  var pos1 = false;
	  var pos2 = false;
	  var pos3 = false;
	...
	var isBoardFull = function isBoardFull(array) {
	  var total = 0;
	...
	var gamesPlayedSuccess = function gamesPlayedSuccess(data) {
	  ...
	  $('#prompt').empty();
	  for (var _i = 0; _i < gameArray.length; _i++) {
	    $('#prompt').append('<br>' + gameArray[_i] + '</br>');
	  }
	  // $('#prompt').html(gameArray)
	};
	var gamePlayedSuccess = function gamePlayedSuccess(data) {
	  var currGame = void 0;
	  console.log(_typeof(store.currentGameId));
	  for (var i = 0; i < data.games.length; i++) {
	...
	var gameOverrideFailsafe = function gameOverrideFailsafe(data) {
	  console.log(data.games);
	};

	var gamesPlayedFailure = function gamesPlayedFailure(error) {
	  console.log(error);
	...
	var joinGameSuccess = function joinGameSuccess(data) {
	  console.log(data);
	  store.counter = 0;
	};

	var joinGameFailure = function joinGameFailure(data) {
	  console.log(data);
	  $('#create-game').hide();
	  $('.container').show();
	  $('#join-game').hide();
	...
	var box1ClickSuccess = function box1ClickSuccess() {
	...
	var box2ClickSuccess = function box2ClickSuccess() {
	  console.log('counter: ' + store.counter);
	  if (store.counter > -1 && store.counter < 9) {
	    if (store.counter % 2) {
	      $('#prompt').text("Player X's Turn!");
	...
	var box3ClickSuccess = function box3ClickSuccess() {
	  console.log('counter: ' + store.counter);
	  if (store.counter > -1 && store.counter < 9) {
	    if (store.counter % 2) {
	      $('#prompt').text("Player X's Turn!");
	...
	var box4ClickSuccess = function box4ClickSuccess() {
	  console.log('counter: ' + store.counter);
	  if (store.counter > -1 && store.counter < 9) {
	    if (store.counter % 2) {
	      $('#prompt').text("Player X's Turn!");
	...
	var box5ClickSuccess = function box5ClickSuccess() {
	  console.log('counter: ' + store.counter);
	  if (store.counter > -1 && store.counter < 9) {
	    if (store.counter % 2) {
	      $('#prompt').text("Player X's Turn!");
	...
	var box6ClickSuccess = function box6ClickSuccess() {
	  console.log('counter: ' + store.counter);
	  if (store.counter > -1 && store.counter < 9) {
	    if (store.counter % 2) {
	      $('#prompt').text("Player X's Turn!");
	...
	var box7ClickSuccess = function box7ClickSuccess() {
	  console.log('counter: ' + store.counter);
	  if (store.counter > -1 && store.counter < 9) {
	    if (store.counter % 2) {
	      $('#prompt').text("Player X's Turn!");
	...
	var box8ClickSuccess = function box8ClickSuccess() {
	  console.log('counter: ' + store.counter);
	  if (store.counter > -1 && store.counter < 9) {
	    if (store.counter % 2) {
	      $('#prompt').text("Player X's Turn!");
	...
	var box9ClickSuccess = function box9ClickSuccess() {
	  console.log('counter: ' + store.counter);
	  if (store.counter > -1 && store.counter < 9) {
	    if (store.counter % 2) {
	      $('#prompt').text("Player X's Turn!");
	...
	var boardCleared = function boardCleared() {
	  api.updateGame();
	  api.signOut();
	  $('.container').hide();
	  $('#sign-in').show();
	...
	var isGameInPlay = function isGameInPlay(data) {
	  var localGame = false;
	  for (var i = 0; i < data.games.length; i++) {
	...
	var gameIsOver = function gameIsOver(data) {
	  api.signOut();
	  $('.container').hide();
	  $('#sign-in').show();
	  $('#games-over').hide();
	...
	module.exports = {
	  ...
	  gamesPlayedSuccess: gamesPlayedSuccess,
	  gamePlayedSuccess: gamePlayedSuccess,
	  gamesPlayedFailure: gamesPlayedFailure,
	  createGameSuccess: createGameSuccess,
	  createGameFailure: createGameFailure,
	  joinGameSuccess: joinGameSuccess,
	  joinGameFailure: joinGameFailure,
	  isGameInPlay: isGameInPlay,
	  gameIsOver: gameIsOver,
	  box1ClickSuccess: box1ClickSuccess,
	  box2ClickSuccess: box2ClickSuccess,
	  box3ClickSuccess: box3ClickSuccess,
	  box4ClickSuccess: box4ClickSuccess,
	  box5ClickSuccess: box5ClickSuccess,
	  box6ClickSuccess: box6ClickSuccess,
	  box7ClickSuccess: box7ClickSuccess,
	  box8ClickSuccess: box8ClickSuccess,
	  box9ClickSuccess: box9ClickSuccess,
